  ...
  return (
    <div className="space-y-6">
      <div className="flex rounded-xl border border-[var(--border)] bg-white p-1.5 text-base">
        <span className="flex-1 rounded-lg bg-purple-light py-3 text-center font-medium text-purple-dark">
          ⚡ 快速模式
        </span>
        <span className="flex-1 py-3 text-center text-[var(--text-secondary)]">
          🌿 深度模式
        </span>
      </div>
